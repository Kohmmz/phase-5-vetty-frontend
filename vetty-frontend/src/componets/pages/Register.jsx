...
const Register = () => {
    ...
    useEffect(() => {
        ...
        if (location.pathname === '/verify-email' && tokenParam) {
            dispatch(verifyEmail(tokenParam, navigate))
                .then(() => {
                ...
                .catch(() => {
                    // On failure, still navigate to login to show login form
                    setAction('login');
                    navigate('/login');
                });
        }
    ...
    const handleRegistration = async (e) => {
        ...
        dispatch(registerUser(formData.username, formData.email, formData.password, userType, null, setFormData, setAction));
    };
